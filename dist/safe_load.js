...
exports.validate = function (payload, schema) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
                                ...
                                return __generator(this, function (_b) {
                                    switch (_b.label) {
                                        ...
                                        case 1:
                                            _b.trys.push([1, 3, , 4]);
                                            _a = resolve;
                                            return [4 /*yield*/, exports.validate(payload[key], schema[key])];
                                        case 2:
            ...
            case 1: return [2 /*return*/, (_a.sent()).reduce(function (previousValue, currentValue) {
                    currentValue = __assign({}, currentValue, previousValue);
                    return currentValue;
                })];
        }
    });
